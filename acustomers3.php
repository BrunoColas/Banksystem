...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        ...
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:#fff; opacity:1;"> 
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:#800000;font-weight:1em;font-size:20px">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="viewcustomers3.php" style="color:#800000;font-weight:1em;font-size:20px">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transferrecords3.php" style="color:#800000;font-weight:1em;font-size:20px">
...
<div class="row">
    <div class="col-sm" style="padding:1% 3%;border-radius:10px;background-color:rgb(228, 228, 245);">
 
    <img  height="50" src="customer.png" alt="" style="display:inline;">&nbsp;
    ...
    <div class="col-sm" style="padding:1% 3%;margin-left:2px;border-radius:10px; background-color: rgb(168, 183, 235);">
        <div >
                    <form action="transfers3.php" method="POST">
                        
                    <img  height="50" src="money.png" alt="" style="display:inline;">&nbsp;
                ...
                <br><br><br>
                        ...
                        <br><br><br>
                        <button id="transfer"  name="transfers" class="btn btn-default" ><b>Transfer</b></button>
                        </form>
        </div>
    </div>
</div>
